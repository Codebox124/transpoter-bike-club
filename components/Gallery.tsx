      ...
      <section className="bg-gray-900 py-24 px-6 md:px-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <button className="px-8 py-3 bg-green-500 text-gray-900 font-semibold rounded-md hover:bg-green-400 transition duration-300 shadow-md inline-flex items-center">
