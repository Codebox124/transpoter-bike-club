      ...
      <section className="bg-gray-900 py-24 px-6 md:px-16">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-300">
            <div className="p-10 flex flex-col h-full justify-between border-b-4 border-red-500">
              <div>
                <div className="w-16 h-16 bg-red-500 rounded-lg mb-6 flex items-center justify-center">
              ...
              <button className="px-8 py-3 bg-red-500 text-gray-900 font-semibold rounded-md hover:bg-red-400 transition duration-300 inline-flex items-center self-start">
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-300 h-full min-h-80">
            ...
            <div className="absolute bottom-0 p-10 w-full">
              <span className="bg-red-500 text-gray-900 text-xs font-semibold px-3 py-1 rounded-md uppercase tracking-wider mb-4 inline-block">{t.features.card2.badge}</span>
              ...
              <button className="px-8 py-3 bg-red-500 text-gray-900 font-semibold rounded-md hover:bg-red-400 transition duration-300 inline-flex items-center">
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-300 h-full min-h-80">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
            <div className="absolute bottom-0 p-10 w-full">
              <span className="bg-red-500 text-gray-900 text-xs font-semibold px-3 py-1 rounded-md uppercase tracking-wider mb-4 inline-block">{t.features.card3.badge}</span>
