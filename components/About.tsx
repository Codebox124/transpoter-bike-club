        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 hidden md:block">
              <div className="bg-red-500 w-32 h-32 rounded-lg opacity-70"></div>
            </div>
          </div>
          
          <div className="text-white relative z-10">
            <h4 className="text-red-400 font-semibold tracking-wider uppercase mb-2">{t.about.sectionTitle}</h4>
            ...
            <div className="flex items-center space-x-4">
              <a 
                href="/about" 
                className="px-8 py-3 bg-red-500 text-gray-900 font-semibold rounded-md hover:bg-red-400 transition duration-300 inline-flex items-center"
              >
                {t.about.buttonStory}
              </a>
              <a 
